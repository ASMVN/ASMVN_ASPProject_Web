...
$stmt = sqlsrv_query($conn, "SELECT * FROM ASPEmpDevices ORDER BY AutoID DESC");
$devices = [];
...
<div id="addModal"
  ...
  <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl overflow-auto">
    <div class="px-6 py-4 border-b">
      <h2 class="text-xl font-bold">Thêm Thiết bị</h2>
    </div>
    <form action="add" method="post" class="px-6 py-4 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Cột 1 -->
         <div>
          ...
          <input type="text" name="Tool_ID" required
        ...
        <div>
          ...
          <select type="text" name="DevicesType"
                 class="w-full border px-2 py-1 rounded focus:ring focus:ring-blue-200">
